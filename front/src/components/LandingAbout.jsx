...
export const LandingAbout = () => {
  return (
    <div className=" flex w-full h-screen lg:h-[60vh] p-0 justify-center items-center lg:p-8 ">
      <div className='relative  flex flex-col items-center justify-center w-full h-full lg:w-[70%] p-4  lg:rounded-lg lg:p-12 bg-[url("/assets/Living-Room.jpg")] grayscale-75 bg-cover bg-center text-[#eeece9] '>
        <div className=" absolute inset-0  bg-black opacity-70 lg:rounded-lg "></div>
        <h2 className="z-10 text-4xl mb-4 lg:mb-10">Sobre nosotros</h2>
        <p className="relative z-10 font-secondary lg:leading-8 text-xl md:text-2xl w-full text-center ">
