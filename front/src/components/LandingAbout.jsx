...
export const LandingAbout = () => {
  return (
    <div className=" flex w-full h-screen lg:h-[60vh] p-0 justify-center items-center lg:p-8 ">
      <div className='relative  flex flex-col items-center justify-center w-full h-full lg:w-[90%] p-4  lg:rounded-lg lg:p-12 bg-[url("/assets/Living-Room.jpg")] grayscale-75 bg-cover bg-center text-[#eeece9] '>
