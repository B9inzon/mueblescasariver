      ...
      <div className="flex flex-col w-full h-full lg:h-[70vh] lg:w-full  lg:flex-row md:px-10 lg:px-14 xl:px-[15vw] gap-5 pt-20 lg:gap-20  ">
        ...
        <div className="flex  flex-col w-full text-[#3c3a36] xxs:h-[60vh] xs:h-[45vh] lg:h-full lg:w-[40%] gap-2 px-4 lg:pl-5 lg:pt-2  ">
          ...
          <h3 className=" font-bold ">
            <span className="text-xl lg:text-3xl mr-2">{formatter.format(finalPrice)}</span>
            <span className={`line-through text-[#3c3a36]/50 mr-5 ${percentageOff <= 0 ? "hidden": ""} `}>
              {formatter.format(price)}
            </span>
          <span className={` h-14 w-14 text-green-500 text-2xl font-bold ${percentageOff <= 0 ? "hidden": ""} `}  >
            ({percentageOff}%)
          </span>
          </h3>
