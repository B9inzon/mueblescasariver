...
export default function ProductCard({
  ...
  return (
    <div className="flex flex-col justify-between items-center px-1 md:px-2 pt-2.5 min-h-[400px] w-[48vw] h-[70vw] md:w-[31vw] md:h-[65vw] lg:w-[31.5vw] lg:h-[50vw] xl:w-[24.3vw] xl:h-[600px] border border-[#3c3a36] text-[#3c3a36]   ">
