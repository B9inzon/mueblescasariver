...
export const Footer = () => {
  return (
    <div className="flex flex-col h-[70%] lg:h-[60vh]  py-10 items-center justify-around text-[#3C3A36] leading-10  ">
        <h1 className='flex font-bold text-xl  h-50 items-center justify-center md:text-2xl w-[80%] border-t-2 border-b-2 border-[#3c3836] '>Siguenos en @mueblescasariver</h1>
