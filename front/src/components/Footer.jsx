...
export const Footer = () => {
  return (
    <div className="flex flex-col h-auto lg:h-[70vh]  py-10 items-center justify-around text-[#3C3A36] leading-10  ">
      ...
      <div className="flex flex-col lg:flex-row w-full lg:w-full xl:w-[60vw] text-center  text-base leading-10 items-center lg:items-start lg:justify-between">
        <ul className="mb-10 w-full 0 lg:w-1/3">
        ...
        <ul className="mb-10 w-full  lg:w-1/3">
